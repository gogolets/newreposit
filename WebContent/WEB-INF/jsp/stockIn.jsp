...
<div class="whole">
    ...
    经办人：<input type="search" style="height: 30px" placeholder="按员工编号查询" class="text">&nbsp;&nbsp;
    <img src="${pageContext.request.contextPath}/images/query.jpg" class="img1">&nbsp;<input type="submit" value="查询" class="button">&nbsp;&nbsp;
    <img src="${pageContext.request.contextPath}/images/add.png" class="img2">&nbsp;<a href="stockinInsert.do">新增</a>&nbsp;&nbsp;
    ...
    <table id="cs_table" border-color="blue" class="data-table">
        ...
        <tr>
			...
			<td>${s.employeeid.ename}</td>
               <td><a href="${pageContext.request.contextPath}/deleteStock.do?sid=${s.sid}">删除</a>&nbsp;
					<a href="${pageContext.request.contextPath}/stock-update.do?sid=${s.sid}">修改</a>
				</td>
            </tr>
         </c:forEach>
        </tbody>
