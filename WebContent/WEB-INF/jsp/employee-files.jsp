...
<div class="whole">
    ...
    <img src="${pageContext.request.contextPath}/images/add.png" class="img2">&nbsp;<a href="employee-insert.do">新增</a>&nbsp;&nbsp;
    ...
    <table id="cs_table" border-color="blue" class="data-table">
        ...
        <c:forEach items="${e}" var="e2">
			<tr>	
				...
				<td>${e2.etelephone}</td>
				<td>${e2.eemail}</td>
				<td><a href="${pageContext.request.contextPath}/deleteEmp.do?ecode=${e2.ecode}">删除</a>&nbsp;
					<a href="${pageContext.request.contextPath}/employee-update.do?ecode=${e2.ecode}">修改</a>
				</td>		
			</tr>
		</c:forEach>
        </tbody>
