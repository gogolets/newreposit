...
<div class="whole">
    ...
    <img src="${pageContext.request.contextPath}/images/add.png" class="img2">&nbsp;<a href="client-insert.do">新增</a>&nbsp;&nbsp;
        ...
        <tbody id="group_one">
         <c:forEach items="${c}" var="c1">
			<tr>	
				...
				<td>${c1.ctelephone}</td>
				<td>${c1.cemail}</td>
				<td><a href="${pageContext.request.contextPath}/deleteCus.do?ccode=${c1.ccode}">删除</a>
					<a href="${pageContext.request.contextPath}/client-update.do?ccode=${c1.ccode}">修改</a>
				</td>		
			</tr>
		</c:forEach>
        </tbody>
