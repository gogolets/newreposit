...
<div class="whole">
    ...
    商品名称：<input type="search" style="height: 30px" placeholder="请输入商品名称" class="text">&nbsp;&nbsp;
    <img src="${pageContext.request.contextPath}/images/query.jpg" class="img1">&nbsp;<input type="submit" value="查询" class="button">&nbsp;&nbsp;
    <img src="${pageContext.request.contextPath}/images/add.png" class="img2">&nbsp;<a href="orderInsert.do">新增</a>&nbsp;&nbsp;
    ...
    <table id="cs_table" border-color="blue" class="data-table">
      ...
      <c:forEach items="${ord}" var="o">
        <tr>
            ...
            <td><a href="${pageContext.request.contextPath}/deleteOrd.do?oid=${o.oid}">删除</a>&nbsp;
					<a href="${pageContext.request.contextPath}/order-update.do?oid=${o.oid}">修改</a>
				</td>
        </tr>
         </c:forEach>
        </tbody>
